package com.yuliang.tutorial.mum.mpp.lesson9.assignment.labs.prob2;
...
public class Main {
	...
	private void showAllOrderItems() {
		System.out.println("\n==============\nAll order items:");
		Stream<OrderItem> orderItemStream = orders.stream()
				.map(order -> order.getOrderItems())
				.flatMap(orderItems -> orderItems.stream());

		orderItemStream.forEach(System.out::println);
	}
