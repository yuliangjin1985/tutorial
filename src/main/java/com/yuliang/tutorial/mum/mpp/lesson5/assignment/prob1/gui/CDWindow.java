package com.yuliang.tutorial.mum.mpp.lesson5.assignment.prob1.gui;

import com.yuliang.tutorial.mum.mpp.lesson5.assignment.prob1.rulesets.RuleException;
import com.yuliang.tutorial.mum.mpp.lesson5.assignment.prob1.rulesets.RuleSet;
import com.yuliang.tutorial.mum.mpp.lesson5.assignment.prob1.rulesets.RuleSetFactory;
...
public class CDWindow extends JFrame {
	...
	class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent evt){
			...
			try {
				RuleSet cdWindowRuleSet = RuleSetFactory.getRuleSet(CDWindow.this);
				cdWindowRuleSet.applyRules(CDWindow.this);
			} catch (RuleException e) {
				JOptionPane.showMessageDialog(CDWindow.this, e.getMessage());
			}
			String output = "artist: " + artistField.getText().trim() + ", title: " + titleField.getText().trim() + ", price: " + priceField.getText().trim();
